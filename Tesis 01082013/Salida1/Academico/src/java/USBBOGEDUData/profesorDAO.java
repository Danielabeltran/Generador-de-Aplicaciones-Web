...
public void create(profesor a) {
        ...
        try{
            ...
            String formato = "insert into profesor([id, nombre, usuario, clave, id, id_Profesor, id_Universidad, asignatura, grupo, horario, id, id_Universidad, codigo, nombre, usuario, clave, email, id_Estudiante, id_Curso, corte1, corte2, corte3, id, nombre, usuario, clave]) values(['%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s', '%s'])"; 
    ...
    public List<profesor> getAll(){
        ...
        database.makeConnection();
            ...
            // Ejecuta la sentencia en la BD
                ResultSet resultado = database.query("select * from profesor");
      ...
      // Crea la conexion a la base de datos Academico
        ...
        try{
            ...
            // Crea la sentencia de actualizacion en la tabla profesor
             String formato = "update profesor set [id='%s', nombre='%s', usuario='%s', clave='%s', id='%s', id_Profesor='%s', id_Universidad='%s', asignatura='%s', grupo='%s', horario='%s', id='%s', id_Universidad='%s', codigo='%s', nombre='%s', usuario='%s', clave='%s', email='%s', id_Estudiante='%s', id_Curso='%s', corte1='%s', corte2='%s', corte3='%s', id='%s', nombre='%s', usuario='%s', clave='%s'] where id='%s'";
            String sql = String.format(formato, [a.get_Id(), a.get_Nombre(), a.get_Usuario(), a.get_Clave(), a.get_Id(), a.get_Id_Profesor(), a.get_Id_Universidad(), a.get_Asignatura(), a.get_Grupo(), a.get_Horario(), a.get_Id(), a.get_Id_Universidad(), a.get_Codigo(), a.get_Nombre(), a.get_Usuario(), a.get_Clave(), a.get_Email(), a.get_Id_Estudiante(), a.get_Id_Curso(), a.get_Corte1(), a.get_Corte2(), a.get_Corte3(), a.get_Id(), a.get_Nombre(), a.get_Usuario(), a.get_Clave()]);
...
// Crea la conexion a la base de datos Academico
        ...
        try{
            ...
            String formato = "delete from profesor where id = %s";
